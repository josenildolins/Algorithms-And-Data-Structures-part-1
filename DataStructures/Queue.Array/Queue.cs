...
namespace Queue.Array
{
    ...
    public class Queue<T> : IEnumerable<T>
    {
        ...
        // Theindex of the last (newest) item in the queue
        private int _tail = -1;

        /// <summary>
        /// Adds an item to the back of the queue
        /// </summary>
        /// <param name="items">The item to place in the queue</param>
        public void Enqueue(T items)
        {
            ...
            if (_items.Length == _size)
            {
                ...
                if (_size > 0)
                {
                    ...
                    // else copy from head to end of the array an then from 0 to the tail
        ...
        /// <summary>
        /// Returns an enuerator that enumerates the queue
        /// </summary>
